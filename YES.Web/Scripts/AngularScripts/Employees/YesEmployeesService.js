...
yesApp.factory('EmployeesService', function ($http) {
    ...
    // Delete an employees from the web api call
    EmployeesServiceFactory.DeleteEmployee = function (EmployeeID) {

        var promise = $http({ method: 'GET', url: 'api/Employee/DeleteEmployee/' + EmployeeID }).
            success(function (data, status, headers, config) {
                // this callback will be called asynchronously
                // when the response is available
                return data;
